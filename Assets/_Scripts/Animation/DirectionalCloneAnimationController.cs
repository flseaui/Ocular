...
{
    public class DirectionalCloneAnimationController : SerializedMonoBehaviour
    {
        ...
        private DirectionalClone _clone;
        ...
        private void Awake()
        {
            _clone = GetComponent<DirectionalClone>();
        ...
        private void Update()
        {
            ...
            if (_currentAnimation.LastFrame)
            {
                ...
                {
                    GetComponent<DirectionalClone>().ActuallyDie();
                }
            }
        }
